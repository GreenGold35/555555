...
public final class c {
    ...
    private final CameraDevice.StateCallback B = new CameraDevice.StateCallback() {
        ...
        public final void onOpened(CameraDevice cameraDevice) {
            CameraDevice unused = c.this.d = cameraDevice;
            c.e.release();
        }
    };
        ...
        public final void onImageAvailable(ImageReader imageReader) {
            if (c.e.tryAcquire()) {
                ...
                if (acquireNextImage != null) {
                    ...
                    Image unused = c.this.s = acquireNextImage;
                }
                c.e.release();
            }
        }
        ...
        try {
            if (this.k != 0 && this.l >= 0.0f && this.l <= 1.0f && this.m >= 0.0f) {
                if (this.m <= 1.0f) {
                    ...
                    int max2 = Math.max(this.j + 1, Math.min((int) ((((double) (this.i.height() - (this.o * 2))) * (1.0d - ((double) this.m))) + ((double) this.o)), (this.i.height() - this.j) - 1));
                    ...
                    public final void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        ...
                        if (c.this.d != null) {
                            synchronized (c.this.v) {
                                CameraCaptureSession unused = c.this.u = cameraCaptureSession;
                                try {
                                    CaptureRequest.Builder unused2 = c.this.t = c.this.d.createCaptureRequest(1);
                                    if (c.this.y != null) {
