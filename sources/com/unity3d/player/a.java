...
final class a implements d {
    ...
    private static class C0000a implements Runnable {
        private Set a;
        private String b;
        private int c;
        private long d;
        ...
        C0000a(Set set, String str, int i, long j, long j2, int i2, int i3) {
            this.a = set;
            this.b = str;
            this.c = i;
            this.d = j;
        ...
        public synchronized void onStateUpdate(AssetPackState assetPackState) {
            if (assetPackState.status() == 4 || assetPackState.status() == 5 || assetPackState.status() == 0) {
                synchronized (a.a) {
                    ...
                    if (a.this.c.isEmpty()) {
                        a.this.a(a.this.d);
                        Object unused = a.this.d = null;
                    }
                }
            }
            if (this.b.size() != 0) {
                new Handler(this.c).post(new C0000a(a(this.b), assetPackState.name(), assetPackState.status(), assetPackState.totalBytesToDownload(), assetPackState.bytesDownloaded(), assetPackState.transferProgressPercentage(), assetPackState.errorCode()));
            }
        }
    ...
    private static class c implements OnSuccessListener {
        ...
        private static class C0001a implements Runnable {
            private IAssetPackManagerMobileDataConfirmationCallback a;
            private boolean b;

            C0001a(IAssetPackManagerMobileDataConfirmationCallback iAssetPackManagerMobileDataConfirmationCallback, boolean z) {
        ...
        public void onSuccess(Integer num) {
            if (this.a != null) {
                new Handler(this.b).post(new C0001a(this.a, num.intValue() == -1));
            }
        }
    }
    ...
    private static class d implements OnCompleteListener {
        ...
        private void a(String str, int i, int i2, long j) {
            new Handler(this.b).post(new C0000a(Collections.singleton(this.a), str, i, j, i == 4 ? j : 0, 0, i2));
        }
    ...
    private static class e implements OnCompleteListener {
        ...
        private static class C0002a implements Runnable {
            private IAssetPackManagerStatusQueryCallback a;
            private long b;
            private String[] c;
            private int[] d;
            ...
            C0002a(IAssetPackManagerStatusQueryCallback iAssetPackManagerStatusQueryCallback, long j, String[] strArr, int[] iArr, int[] iArr2) {
        ...
        public final void onComplete(Task task) {
            if (this.a != null) {
                ...
                try {
                    ...
                    new Handler(this.b).post(new C0002a(this.a, assetPackStates.totalBytes(), strArr, iArr, iArr2));
                } catch (RuntimeExecutionException e) {
                    String message = e.getMessage();
                    for (String str : this.c) {
                        if (message.contains(str)) {
                            new Handler(this.b).post(new C0002a(this.a, 0, new String[]{str}, new int[]{0}, new int[]{e.getErrorCode()}));
                            return;
                        }
                    }
                    ...
                    new Handler(this.b).post(new C0002a(this.a, 0, this.c, iArr3, iArr4));
                }
            }
        }
    }
